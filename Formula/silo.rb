...
class Silo < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "7cb5d095ed98defb418bb14b3914998b74bfbb06b3401e9e2074a8e43d947ccd"
    else
      url "https://github.com/StanleyXie/silo/releases/download/v#{version}/silo-darwin-amd64.tar.gz"
      sha256 "805681c1a68a3fe107b2c0bc9f06f92e6bf70869205597201fb999f076abedb3"
    end
  end

  on_linux do
    url "https://github.com/StanleyXie/silo/releases/download/v#{version}/silo-linux-amd64.tar.gz"
    sha256 "42120fdbf9002f0fe442c1183540d4d479bc8eea04ed4112f4d25f7568ce3657"
  end
